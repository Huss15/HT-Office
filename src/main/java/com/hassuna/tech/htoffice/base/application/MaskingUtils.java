...
public class MaskingUtils {
    ...
    /**
     * Masks all characters in the input string except for the last three characters.
     * If the input string is null or has three or fewer characters, it is returned unchanged.
     *
