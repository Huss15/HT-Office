...
public class CreateInvoice {
    ...
    public Invoice getExample() {
        ...
        // Absender (Lieferant)
        TradeParty sender = new TradeParty("Bananen-Lieferservice GmbH", "Musterstraße 1", "54321", "Musterstadt", "DE")
        ...
        // Empfänger (Kunde)
        TradeParty recipient = new TradeParty("Testkunde AG", "Kundenweg 8", "12345", "Berlin", "DE")
                .setName("Frau Erika Kunde")
                .setEmail("erika.kunde@testkunde.de");
        invoice.setRecipient(recipient);

        // Rechnungsposition
        Product bananaProduct = new Product("B001", "Premium Bananen aus Ecuador", "C62", new BigDecimal("50.00")); // C62 = Stück
        Item bananaItem = new Item(bananaProduct, new BigDecimal("50.00"), new BigDecimal("19.00"))
                .setId("1");
