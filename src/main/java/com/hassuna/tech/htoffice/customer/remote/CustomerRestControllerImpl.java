...
public class CustomerRestControllerImpl implements CustomerRestController {
    ...
    @Autowired
    public CustomerRestControllerImpl(B2bCustomerService b2bCustomerService, B2cCustomerService b2cCustomerService) {
    ...
    public ResponseEntity<B2bCustomerPayload> createB2bCustomer(@RequestBody CreateB2bCustomerPayload requestBody) {
    ...
    public ResponseEntity<B2cCustomerPayload> createB2cCustomer(CreateB2cCustomerPayload requestBody) {
        log.debug("Received request to create B2C customer: {} {}", requestBody.firstname(), requestBody.lastname());
    ...
    public ResponseEntity<B2bCustomerPayload> getB2bCustomerByCustomerId(@PathVariable String customerId) {
    ...
    public ResponseEntity<B2cCustomerPayload> getB2cCustomerByCustomerId(@PathVariable String customerId) {
